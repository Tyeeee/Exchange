package com.hynet.heebit.components.widget.circleimageview;
...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (typedArray.hasValue(R.styleable.CircleImageView_civ_background_olor)) {
            backgroundColor = typedArray.getColor(R.styleable.CircleImageView_civ_background_olor, DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (typedArray.hasValue(R.styleable.CircleImageView_civ_fill_color)) {
            backgroundColor = typedArray.getColor(R.styleable.CircleImageView_civ_fill_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
        typedArray.recycle();
        initialize();
    }
