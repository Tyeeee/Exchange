...
object ScreenshotTaker {
    ...
    private fun drawRootsToBitmap(viewRoots: List<RootViewInfo>, bitmap: Bitmap, ignoredViews: Array<out View>?) {
        for (rootData in viewRoots) {
            drawRootToBitmap(rootData, bitmap, ignoredViews)
        }
    }

    private fun drawRootToBitmap(rootViewInfo: RootViewInfo, bitmap: Bitmap, ignoredViews: Array<out View>?) {
        if (rootViewInfo.layoutParams!!.flags and WindowManager.LayoutParams.FLAG_DIM_BEHIND == WindowManager.LayoutParams.FLAG_DIM_BEHIND) {
    ...
    private fun drawGLSurfaceView(surfaceView: GLSurfaceView, canvas: Canvas) {
        LogUtil.instance.print("Drawing GLSurfaceView")
    ...
    private fun drawTextureView(textureView: TextureView, canvas: Canvas) {
        LogUtil.instance.print("Drawing TextureView")
